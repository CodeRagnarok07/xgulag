        ...
        <a href="https://kingcord.xyz/" target="_blank" rel="noreferrer"  >
          ...
          <div className='flex items-center justify-between w-full'>
            <div className='w-full flex justify-center h-32 relative cursor-pointer group'>
              ...
              <div className='group-hover:opacity-100 opacity-0 text-center absolute inset-0 transition1 hover:translate-y-2'>A través de una sencilla e intuitiva página web podrás adquirir una serie de plantillas diseñadas para todo tipo de estilos a gusto del consumidor, incluyendo banners y normas base, pero eso no es todo, gracias a Kingbot tu servidor estará totalmente gestionado y administrado con las tareas que necesite desempeñar.
        ...
        <a href="https:/www.turing-ai.xyz" target="_blank" rel="noreferrer"  >
          <div className='flex items-center justify-between w-full'>
            <div className='w-full flex justify-center h-32 relative cursor-pointer group'>
              ...
              <div className='group-hover:opacity-100 opacity-0 text-center absolute inset-0 transition1 hover:translate-y-8'>Es la centralización de diversas inteligencias artificiales en una sola App donde los usuarios pueden interactuar con ellas .
              </div>
            </div>
